...
class nodeD extends JFrame implements ActionListener
{
	JComboBox jcdest;
	...
	void createwin()
	{
		...
		JLabel jl=new JLabel("NODE D",JLabel.CENTER);
	...
	public static void main(String args[])
	{
            ...
            java.util.logging.Logger.getLogger(nodeD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
