...
class nodeB extends JFrame implements ActionListener
{
	JComboBox jcdest;
	...
	void createwin()
	{
		...
		JLabel jl=new JLabel("NODE B",JLabel.CENTER);
		...
		try
		{
			...
			if (reply.equals("SUCCESS"))
			{
				...
				JOptionPane.showMessageDialog(this,"Successfully Registered\nPublic Key(Q)="+q+"\nPrivate Key(K)="+k);
                        ...
                        {
                            JOptionPane.showMessageDialog(this, "Node already registered with RSU!");
                        }
			else
	...
	public static void main(String args[])
	{
            ...
            java.util.logging.Logger.getLogger(nodeB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
		new nodeB();
	}
}
